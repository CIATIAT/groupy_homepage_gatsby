...
const Background = () => (
  <>
    <Triangle color="color3" height={["50vh", "20vh"]} width={["50vw", "50vw"]} position="bottom-left" />

    <Triangle color="color4" height={["20vh", "40vh"]} width={["75vw", "70vw"]} position="top-right" />

    <Triangle color="color4" height={["25vh", "20vh"]} width={["100vw", "100vw"]} />
  </>
);
